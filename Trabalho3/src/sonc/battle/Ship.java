...
<<<<<<< HEAD
	...
	public static void setMaxShipRotation(double maxShipRotation) {
	...
	public static void setMaxStatus(int maxStatus) {
	...
	public void setLastFireRound(int lastFireRound) {
